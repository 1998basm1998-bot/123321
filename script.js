...
function printReceipt() {
    ...
    <div class="receipt-print-container" style="border: 2px solid #000; padding: 15px; font-family: Arial, sans-serif; direction: rtl; width: 100%; box-sizing: border-box; height: 96vh; display: flex; flex-direction: column; justify-content: center; margin: 0 auto;">
